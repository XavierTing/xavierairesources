...
const TOOLS = [
  ...
  },
  {
    ...
    cost: "The wrapper and the separate gosom scraping engine are each free under an MIT code licence. Those licences do not grant rights to collect, keep or redistribute Google Maps data. Claude Code has its own plan, and proxy services for large or repeated jobs may cost extra.",
    ...
    commandTarget: "terminal",
    status: "Reviewed · Not tested",
    note: "A useful local wrapper around gosom's scraper, with a ready-made Claude skill and spreadsheet output. Start without email collection, keep it on your own computer and check every result. Job data persists until you delete it, and the repository itself says Maps scraping is against Google's terms."
  },
];
