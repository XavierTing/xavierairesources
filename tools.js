...
const TOOLS = [
  ...
  },
  {
    ...
    how: [
      "Check that Python 3.12 or newer is installed. Use Python's virtual-environment guide at https://docs.python.org/3/library/venv.html for your computer to create and activate a virtual environment, an isolated folder for this project's Python packages, so the install does not conflict with other projects.",
      ...
      "Choose a local Ollama model or configure an outside AI provider. Before you run a test, check the website's terms and robots.txt instructions, use a public page you have permission to collect, and do not gather personal or restricted data or bypass access controls. An outside provider may receive your request and page content and may charge for usage. Check the result against the page before saving or acting on it."
    ],
    command: "pip install scrapegraphai && playwright install",
    commandTarget: "terminal",
    status: "Reviewed · Not tested",
    note: "The open-source version gives you control, but it also gives you the maintenance work. Start with one permitted page and measure accuracy and model cost before you scale it."
  },
];
